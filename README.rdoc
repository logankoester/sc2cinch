...
3. Set up a MongoDB database to store users information in. I recommend
creating a free account at https://mongohq.com/
...
as it is only RSS). You can also find your current rank information.
